function fyllaKommentar() {
    ...
    // MANDAG - ONSDAG 
    else if ((weekday >= 1 && weekday < 4) && (time > 6 && time < 18)){
        document.getElementById("kommentar").innerHTML = "Jobb hardt nå for en velfortjent hjemmebrygget øl til helga";     // Mellom 06:00 og 18:00 i uken 
    }
